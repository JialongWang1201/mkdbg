...
mkdbg replay build/mkdbg.bundle.json --timeline --event 2 --context 2
mkdbg replay build/mkdbg.bundle.json --timeline --fault
mkdbg replay build/mkdbg.bundle.json --timeline --fault --context 2
